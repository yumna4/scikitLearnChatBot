...
extractEntity("show roomnos where temperature is less than 6")
extractEntity("show me the rooms less than 4")
...
# extractEntity("for all the events in the past 10 minutes display the average temperatures which are bigger than 30 along with their roomNo and deviceID and group all of this by the roomNo")
